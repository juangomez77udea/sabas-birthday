      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-transparent">
        <div className="container mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/"
              className={`hidden md:flex rounded-lg bg-white px-4 h-10 items-center justify-center font-bold shadow-md ${isActive("/") ? "ring-2 ring-blue-500" : ""
                }`}
            >
            ...
            <nav className="hidden md:flex items-center space-x-4">
              <Link
                to="/about"
                className={`rounded-lg bg-white px-4 h-10 items-center justify-center flex font-bold shadow-md ${isActive("/about") ? "text-blue-500 ring-2 ring-blue-500" : "text-black"
                  }`}
              >
              ...
              <Link
                to="/go"
                className={`rounded-lg bg-white px-4 h-10 items-center justify-center flex font-bold shadow-md ${isActive("/go") ? "text-blue-500 ring-2 ring-blue-500" : "text-black"
                  }`}
              >
          ...
          <div
            className={`fixed inset-0 bg-white bg-opacity-95 z-40 flex flex-col items-center justify-center transition-all duration-300 ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"
              }`}
          >
